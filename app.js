...
function multiplyArray(multArr) {
  //eslint-disable-line
  var theMultiply = multiply(
    multArr[0],
    multiply(multArr[1], multArr[2])[0]
  )[0];
...
function multiplyAnyArray(dynamicArray) {
  ...
  for (var i = 0; i < testDynamicArray.length; i++) {
    answ = multiply(answ[0], testDynamicArray[i]);
    msg.push(testDynamicArray[i]);
  }
  return [answ[0], `The numbers ${msg} have a product of ${answ[0]}.`];
}
